...
CREATE TABLE `os_servicos` (
  ...
  CONSTRAINT `os_servicos_ibfk_1` FOREIGN KEY (`ID_Ordem`) REFERENCES `ordens_servico` (`ID_Ordem`),
...
INSERT INTO `os_servicos` (`ID_Ordem`, `ID_Servico`) VALUES (1,1),(2,2),(2,1),(3,3);
