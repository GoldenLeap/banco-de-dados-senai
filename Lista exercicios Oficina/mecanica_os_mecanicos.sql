...
CREATE TABLE `os_mecanicos` (
  ...
  CONSTRAINT `os_mecanicos_ibfk_1` FOREIGN KEY (`ID_Ordem`) REFERENCES `ordens_servico` (`ID_Ordem`),
...
INSERT INTO `os_mecanicos` (`ID_Ordem`, `ID_Mecanico`) VALUES (1,1),(2,2),(3,1),(3,3),(4,3);
